...
async def get_business_settings(business_id: UUID):
    """
...
async def update_business_settings(business_id: UUID, updates: BusinessSettingsUpdate):
    """
    Update business settings
...
async def get_working_hours(business_id: UUID):
    """
...
async def update_working_hours(business_id: UUID, hours: List[WorkingHours]):
    """
...
async def get_integrations(business_id: UUID):
    """
...
async def delete_integration(business_id: UUID, integration_name: str):
